...
def seed_barbers():
    ...
    if Barber.query.count() == 0:
        barbers = [
            Barber(name='Sebastián Mora', specialty='Fades & Diseños', experience_years=8,
                   bio='Maestro del fade perfecto. Especialista en diseños geométricos y líneas precisas.',
                   avatar_initials='SM'),
            Barber(name='Diego Valles', specialty='Barba & Afeitado Clásico', experience_years=12,
                   bio='Experto en el arte del afeitado tradicional. Rituales de barba que transforman.',
                   avatar_initials='DV'),
            Barber(name='Andrés Reyes', specialty='Cortes Premium & Textura', experience_years=6,
                   bio='Especialista en texturas y cortes modernos. Transforma tu imagen con estilo.',
                   avatar_initials='AR'),
            Barber(name='Camilo Ortiz', specialty='Coloración & Tratamientos', experience_years=9,
